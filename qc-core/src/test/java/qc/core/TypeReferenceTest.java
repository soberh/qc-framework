...
public class TypeReferenceTest {
	...
	public void test() {
		...
		Assert.assertEquals("java.util.Map<java.lang.String, qc.test.Example>", tr.getType().toString());
		Assert.assertEquals("java.util.Map", tr.getRawType().getName());
		
		//或者
		TypeToken<Map<String, Example>> tt = new TypeToken<Map<String, Example>>() {};
		Assert.assertEquals("java.util.Map<java.lang.String, qc.test.Example>", tt.getType().toString());
